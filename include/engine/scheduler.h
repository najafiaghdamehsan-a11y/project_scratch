...
typedef struct Instr {
    ...
    double a;      // steps/deg/ms/threshold/etc.
    double b;      // unused for now (future)
    int jump;      // loops/if/else jump target
...
// NEW: start a script thread when a key is pressed (SDL_Keycode as int)
